...
FEEDBACK_CHAT_WINDOW_SECONDS = int(os.getenv("FEEDBACK_CHAT_WINDOW_SECONDS", "600"))
# 客服历史轮询单独限速；只读历史允许页面保持短轮询，发送接口仍使用上面的严格限额。
FEEDBACK_CHAT_HISTORY_MAX_PER_WINDOW = int(os.getenv("FEEDBACK_CHAT_HISTORY_MAX_PER_WINDOW", "600"))
FEEDBACK_CHAT_HISTORY_WINDOW_SECONDS = int(os.getenv("FEEDBACK_CHAT_HISTORY_WINDOW_SECONDS", "600"))
