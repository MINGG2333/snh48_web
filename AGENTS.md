...
- 网站运行依赖 `/home/snh48-fan-hub` 的行程、回放、成员房间上麦发布包、直播封面和图片代理数据；修改 `/timeline`、直播/上麦回放、图片代理或相关环境变量前，先读本项目 profile 的数据工程段落、`snh48-fan-hub/schedule_record/网站开发对接说明.md` 和对应数据契约。
