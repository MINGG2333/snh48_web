...
| 观察页 | `/ob` | 无 | `website/templates/ob.html` | `/api/ob/verify`、`/api/ob/data`、`/api/ob/mark-read`、`/api/ob/inbox/status` | `OB_PASSWORD`；`X-Ob-Password` | 本节点访问日志、通知中心；双服务器可靠待处理箱明确标识腾讯云/阿里云来源 |
